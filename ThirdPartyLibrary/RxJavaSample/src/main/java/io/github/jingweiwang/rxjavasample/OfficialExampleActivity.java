...
public class OfficialExampleActivity extends AppCompatActivity {
    private static final String TAG = "OfficialExampleActivity";
        ...
        disposables.add(sampleObservable()
                ...
                .subscribeWith(new DisposableObserver<String>() {
                    ...
                    public void onNext(String value) {
                        Log.e(TAG, "onNext(" + value + ") by " + Thread.currentThread().getName() + " Thread.");
                    }
                    ...
                    public void onComplete() {
                        Log.e(TAG, "onComplete() by " + Thread.currentThread().getName() + " Thread.");
                    }
                }));
    }
}
