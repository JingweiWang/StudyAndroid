...
public class Test5Activity extends AppCompatActivity {
    ...
    private int textView_space_width = 650;
    private int n = 1;//测试n个距离
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Test5Activity.this)
                .setTitle("感谢!").setMessage("感谢您完成第 4 组试验,请继续.");
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (status >= 30 * n + 1) {
                    ...
                    Intent intent = new Intent(Test5Activity.this, SubmitActivity.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if ((System.currentTimeMillis() - mExitTime) > 2000) {
                ...
                Intent intent = new Intent(Test5Activity.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
            return true;
