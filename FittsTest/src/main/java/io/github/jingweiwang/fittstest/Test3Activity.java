...
public class Test3Activity extends AppCompatActivity {
    ...
    private int textView_space_width = 450;
    private int n = 3;//测试n个距离
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Test3Activity.this)
                .setTitle("感谢!").setMessage("感谢您完成第 2 组试验,请继续.");
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if ((System.currentTimeMillis() - mExitTime) > 2000) {
                ...
                Intent intent = new Intent(Test3Activity.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
            return true;
